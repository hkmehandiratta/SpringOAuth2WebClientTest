...
public class AlbumsController {
    ...
    public List<AlbumRest> getAlbums() { 
        ...
        album1.setAlbumId("albumId1Here");
        album1.setUserId("1");
        album1.setAlbumTitle("Album one-AlbumRest title");
        album1.setAlbumDescription("Album 1 description");
        album1.setAlbumUrl("Album 1 URL");
        
        AlbumRest album2 = new AlbumRest();
        album2.setAlbumId("albumId2Here");
        album2.setUserId("2");
        album2.setAlbumTitle("Album two-AlbumRest title");
